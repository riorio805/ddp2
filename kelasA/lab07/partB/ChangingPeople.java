package ddp2.kelasA.lab07.partB;
...
public class ChangingPeople
{
    ...
    public static void main (String[] args)
    {
        ...
        ChangingPeople ob = new ChangingPeople();
        ob.changePeople(person1, person2, age, name);
    ...
    // -------------------------------------------------------------------
    public void changePeople (Person p1, Person p2, int age,
                              String name)
    {
        ...
        // Make changes
        // Fixed so that it actually changes p2's object by using methods instead
        p2.changeAge(age);
        p2.changeName(name);
        name = "Jack";
        age = 101;
