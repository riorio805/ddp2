...
public class CreditCardValidationString {
    public static void main (String[] args) {
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null,
                    "The number " + cardString + " is " + ((isValid(cardString)) ? "valid." : "invalid."),
                    "Validation of Credit Card / Debit Card Numbers", JOptionPane.PLAIN_MESSAGE);
        }
    }
    ...
    public static int sumOfDoubleEvenPlace (String number) {
        ...
        while (!number.isEmpty()) {
            // parse digit, double, take digital
    ...
    public static int sumOfOddPlace (String number) {
        ...
        // loop until number is empty, taking 2 characters from the left every time
        while (!number.isEmpty()) {
            // parse digit, add to total
            total += Integer.parseInt(number.substring(0,1));
